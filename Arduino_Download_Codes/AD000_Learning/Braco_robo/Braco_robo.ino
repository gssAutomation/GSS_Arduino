...
void loop() {
  ...
  leitura_base = map(leitura_base, 0, 1023, 20, 100);  // Converte valor do potenciometro
  servo_bas.write(leitura_base); // Aciona servo motor, com base na leitura do eixo x

  servo_art.write(l_art); // Aciona servo motor, com base na leitura do eixo x
}
